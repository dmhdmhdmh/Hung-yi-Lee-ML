...
source_dataset = ImageFolder('D:/homeworkpy/Data/hw12/train_data', transform=source_transform)
target_dataset = ImageFolder('D:/homeworkpy/Data/hw12/test_data', transform=target_transform)
