...
path_prefix = 'D:/homeworkpy/Data/hw4'
# 處理好各個data的路徑
train_with_label = os.path.join(path_prefix, 'training_label.txt')
train_no_label = os.path.join(path_prefix, 'training_nolabel.txt')
testing_data = os.path.join(path_prefix, 'testing_data.txt')

w2v_path = os.path.join('D:/homeworkpy/hw4RNN', 'w2v_all.model') # 處理word to vec model的路徑
...
print("save csv ...")
tmp.to_csv(os.path.join('D:/homeworkpy/hw4RNN', 'predict.csv'), index=False)
