...
from Architecture_Design import StudentNet
...
# get dataloader
train_dataloader = get_dataloader('training', batch_size=4)
valid_dataloader = get_dataloader('validation', batch_size=4)
